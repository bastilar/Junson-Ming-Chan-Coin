...
const string strMessageMagic = "junsonmingchancoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    {
      nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * nRewardCoinYear * 3; // 750 %
      return nSubsidy + nFees;
    }  
    ...
    else if (pindexBest->nHeight < 700000)
    {
    ...
    {
      nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * nRewardCoinYear * 1; // 250 %
      return nSubsidy + nFees;
    }  
...
// junsonmingchancoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "junsonmingchancoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
